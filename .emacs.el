...
(custom-set-variables
 ...
 '(clean-buffer-list-kill-never-buffer-names (quote ("*scratch*" "*Messages*" "*server*" "*Group*")))
 '(clean-buffer-list-kill-never-regexps (quote ("^ \\*Minibuf-.*\\*$" "^\\*Summary" "^\\*Article" "^#" "^\\*Org" "todo.txt")))
 ...
 '(erc-autoaway-mode t)
 '(erc-autojoin-channels-alist (quote (("localhost" "#twitter_jwiegley" "&bitlbee") ("freenode.net" "#ledger" "#git"))))
 '(erc-autojoin-mode t)
 ...
 '(erc-modules (quote (autoaway autojoin button completion dcc fill identd irccontrols list log match menu move-to-prompt netsplit networks noncommands readonly ring scrolltobottom services smiley stamp track)))
 '(erc-nick "johnw")
 '(erc-port 6667)
