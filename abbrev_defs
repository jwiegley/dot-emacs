...
(define-abbrev-table 'c++-mode-abbrev-table
  '(
    ("cout" ["std::cout << \"\" << std::endl;" 15 nil nil] expand-abbrev-hook 1)
    ("cerr" ["std::cerr << \"\" << std::endl;" 15 nil nil] expand-abbrev-hook 1)
   ))
...
(define-abbrev-table 'global-abbrev-table
  '(
    ("Abdul" "`Abdu'l-Bahá" nil 1)
    ("Bab" "Báb" nil 1)
    ("Bahai" "Bahá'í" nil 1)
    ("Aqdas" "Kitáb-i-Aqdas" nil 1)
    ("Iqan" "Kitáb-i-Íqán" nil 1)
    ("LSA" "Local Spiritual Assembly" nil 1)
    ("NSA" "National Spiritual Assembly" nil 1)
    ("UHJ" "Universal House of Justice" nil 1)
    ("Bahai" "Bahá'í" nil 2)
   ))
...
(define-abbrev-table 'pages-directory-address-mode-abbrev-table '())
