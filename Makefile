...
init.elc: init.el dot-org.elc dot-gnus.elc
	...
	@$(BATCH_LOAD) -l load-path -f batch-byte-compile init.el

dot-org.elc: dot-org.el
	@rm -f $@
	@echo Compiling file dot-org.el
	@$(BATCH_LOAD) -l load-path -f batch-byte-compile dot-org.el

dot-gnus.elc: dot-gnus.el
	@rm -f $@
	@echo Compiling file dot-gnus.el
	@$(BATCH_LOAD) -l load-path -f batch-byte-compile dot-gnus.el
