...
(use-package gnus-start
  ...
  (gnus-parameters
   '(
     ;; Emacs     spam: Spam[unread] -> Spam[read] -> IsSpam
     ;; Emacs     good: Spam[unread] -> TrainGood -> IsGood
     ;; Emacs     spam: INBOX -> TrainSpam -> IsSpam
     ;; Fastmail  spam: Spam[unread] -> Spam[read] -> IsSpam
     ;; Fastmail  good: Spam[unread] -> TrainGood -> IsGood
     ;; SpamSieve good: Spam[unread] -> INBOX
     ;; Fastmail  spam: INBOX -> TrainSpam -> IsSpam
     ;; SpamSieve spam: INBOX -> IsSpam
     ;;
