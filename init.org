...
(use-package org
  ...
  (org-default-notes-file "~/doc/org/area/todo.org")
...
[PACKAGES]"
  ...
  (org-refile-targets
   '((org-agenda-files :maxlevel . 4)
     ("~/doc/org/resource/bookmarks.org" :maxlevel . 2)))
...
(use-package org-agenda
   ...
   '(("r" . "Review tasks")
     ...
     ("ro" "Unscheduled open source" alltodo ""
      ((org-agenda-skip-function
       ...
       (org-agenda-prefix-format "%-11c%5(org-todo-age) ")
       (org-agenda-files '("~/doc/org/area/OSS.org"))))
      ...
      ((org-agenda-sorting-strategy '(category-up user-defined-up))
       (org-agenda-skip-function
        '(or (org-agenda-skip-entry-if 'scheduled 'deadline 'timestamp)
             (my-org-agenda-skip-habit)))
       (org-agenda-prefix-format "%-11c%5(org-todo-age) ")
       (org-agenda-files '("~/doc/org/area/kadena/kadena.org"))))
  ...
  (org-agenda-files
   '("~/doc/org/area/todo.org"
     "~/doc/org/area/habits.org"
     "~/doc/org/area/kadena/kadena.org"
     "~/doc/org/area/OSS.org"
     "~/Library/Mobile Documents/iCloud~com~appsonthemove~beorg/Documents/org/inbox.org"
     "~/doc/org/resource/people.org"))
...
(use-package org-attach
  ...
  (org-attach-id-dir "~/doc/org/data")
...
(use-package org-contacts
  :after org
  :custom
  (org-contacts-files '("~/doc/org/resource/people.org"))
  :config
...
(use-package org-noter
  ...
  :commands org-noter
  :custom
  (org-noter-notes-search-path '("~/doc/org/inbox"))
       ...
       ((eq major-mode 'dired-mode)
        (let ((org-ql-search-directories-files-recursive t))
          (org-ql-find (org-ql-search-directories-files
                        :directories '("~/doc/org/area" "~/doc/org/resource"))
...
:NOTE: %^{NOTE}
:END:"
      :target (file "~/doc/org/resource/people.org")
      :prepend t)
     ...
     ("N" "Inline Note" entry "* LINK %?"
      ...
      :prepend t)
     ("i" "Idea" entry "* NOTE %?"
      :target (file "~/doc/org/resource/ideas.org")
      :empty-lines 1
      :prepend t)
     ("q" "Quote" plain "%c\n\n─ %?"
...
(use-package citar
  ...
  (org-cite-global-bibliography
   '("~/doc/org/resource/bibliography.bib"
     "~/doc/org/resource/kadena.bib"))
...
(use-package asana
  ...
  :defines (asana-token)
  :custom
  (asana-tasks-org-file "~/doc/org/area/kadena/asana.org")
  :config
  (setq asana-token
