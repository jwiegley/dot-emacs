  ...
  (use-package gptel-ollama
    ...
    (gptel-make-ollama "Ollama"
      ...
      '(
        ...
        (codellama:70b
         :description "LLM that can use text prompts to generate and discuss code"
         :capabilities (media)
         :mime-types ("image/jpeg" "image/png" "text/plain"))
        (deepseek-coder:33b
...
(use-package org
  ...
  (org-columns-default-format "%6Effort(Effort){:} %TODO %64ITEM(Task) %NEXT_REVIEW")
