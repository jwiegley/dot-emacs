...
(use-package org-agenda
  ...
  (org-agenda-custom-commands
   '(("A" "Priority #A tasks" agenda ""
     ...
     ("u" "Unscheduled tasks in last 90 days" tags
      "TODO<>\"\"&TODO<>{DONE\\|CANCELED\\|NOTE\\|LINK\\|PROJECT\\|CATEGORY\\|DEFERRED\\|SOMEDAY}"
      ((org-agenda-skip-function
     ...
     ("o" "Unscheduled open source tasks" tags
      ...
      ((org-agenda-skip-function
       ...
       (org-agenda-files
        '("~/org/area/OSS.org"))))
     ("R" "Review old unscheduled tasks" tags
      "TODO<>\"\"&TODO<>{DONE\\|CANCELED\\|NOTE\\|LINK\\|PROJECT\\|CATEGORY\\|DEFERRED\\|SOMEDAY}"
      ((org-agenda-skip-function
        '(or (org-agenda-skip-entry-if 'scheduled 'deadline 'timestamp)
             (org-extra-agenda-skip-if-within 90)))
       (org-agenda-sorting-strategy '(user-defined-up))
       (org-agenda-prefix-format "%-11c%5(org-todo-age) ")
       (org-agenda-files '("~/org/area/todo.org"
                           "~/org/area/kadena/kadena.org"))))
...
(use-package org-ql
  ...
  (defun my/org-ql-find-with-heading ()
    (interactive)
    (cond
     ((eq major-mode 'dired-mode)
     ...
     ((eq major-mode 'org-mode)
      (org-ql-find (org-ql-find--buffers) :query-prefix "todo:CATEGORY,PROJECT "))
     (t
      (org-ql-find (org-agenda-files) :query-prefix "todo:CATEGORY,PROJECT "))))
  :config
