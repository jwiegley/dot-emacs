     ...
     ("c" "Appointment Calendar" agenda ""
      ((org-agenda-overriding-header "Appointment Calendar")
       ...
       (org-agenda-regexp-filter-preset
        '("+APPT"))))
     ("O" "Sierra Oaks tasks" tags "CATEGORY=\"Sierra\"&TODO<>\"\"&TODO<>{APPT\\|DONE\\|DEFERRED\\|CANCELED\\|NOTE\\|LINK\\|PROJECT}&STYLE<>\"habit\""
      ((org-agenda-overriding-header "Sierra Oaks tasks")
       (org-agenda-skip-function
        '(org-agenda-skip-entry-if 'scheduled))))
