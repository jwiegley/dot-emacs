...
"))
  ...
  (defun org-sync ()
    ...
    (with-current-buffer (find-file-noselect "~/org/area/kadena/kadena.org")
      ...
      (org-sort-all))
    (save-some-buffers t)
    (message "Updating todo files...")
    (my/org-roam-update-todo-files)
    (save-some-buffers t)
    (message "Updating id locations...")
    (org-id-update-id-locations)
    (message "Updating roam database...")
    (org-roam-db-sync)
    (message "Updating xeft database...")
    (xeft-full-reindex)
    (message "Syncing and backing up...")
  ...
  (org-agenda-custom-commands
   '(("A" "Priority #A tasks" agenda ""
     ...
     ("w" "Unscheduled work tasks" tags
      "TODO<>\"\"&TODO<>{DONE\\|DEFERRED\\|CANCELED\\|NOTE\\|LINK\\|PROJECT\\|CATEGORY}"
