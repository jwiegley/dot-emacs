...
[[https://github.com/ndwarshuis/org-sql][org-sql]] code stores org buffers in a variety of SQL databases for use in
processing org-mode data outside of Emacs where SQL operations might be more
appropriate. Org files are stored according to the perspective of unique org
outline; any outline might reside in multiple identical files.
