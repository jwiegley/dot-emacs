...
(use-package org-roam
  ...
  (("C-c n B" . my/org-roam-capture-inbox)
   ...
   ("C-c n f" . org-roam-node-find)     ; overridden by consult-org-roam
...
**** COMMENT org-roam-dailies
:PROPERTIES:
:ID:       546A7601-14CF-4419-9ED3-236667A0A5B1
:END:
...
(use-package org-smart-capture
  ...
  (defun org-roam-smart-capture ()
    (interactive)
    (org-smart-capture nil #'my/org-roam-create-new))
  :custom
