...
(use-package org-capture
  ...
  (org-capture-templates
   '(("a" "Add Task" entry (node "DB5226DB-93BD-4FDC-89C6-0DBE5D1A607E")
      "* TODO %?" :prepend t)
     ("n" "Note" entry (node "DB5226DB-93BD-4FDC-89C6-0DBE5D1A607E")
      "* NOTE %?" :prepend t)
     ("c" "Calendar" entry (node "DB5226DB-93BD-4FDC-89C6-0DBE5D1A607E")
      "* APPT %?" :prepend t)
     ("l" "Link" entry (node "DB5226DB-93BD-4FDC-89C6-0DBE5D1A607E")
      "* LINK %:description%?
:PROPERTIES:
:URL:      %:link
:END:" :prepend t)))
