...
(use-package gptel
  ...
  (gptel-model "deepseek-r1:deepseek-r1:14b")
  :preface
  ...
  (defun my-gptel-update-prompts ()
    (interactive)
    (setq gptel-directives (my-gptel-read-prompts "~/.emacs.d/prompts")))
  :config
...
(use-package org-extra
  ...
  :bind (:map
         ...
         ("C-c C-x #"   . org-extra-update-hash)
         ("C-c C-x C-#" . org-extra-check-hash)
...
(use-package org-srs
  ...
  (use-package org-srs-log
    ...
    (advice-add 'org-srs-log-hide-drawer
                :after #'(lambda (&rest _ignore)
                           (org-extra-cycle-hide-drawers 'all)))))
#+end_src
