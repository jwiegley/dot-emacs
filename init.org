...
(use-package vulpea
  ...
  ;; hook into org-roam-db-autosync-mode if you wish to enable persistence of
  ;; meta values (see respective section in README to find out what meta
  ;; means)
