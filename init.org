...
[PACKAGES]"
  ...
  (org-todo-keywords
   '((sequence "DOING(s!/!)" "TODO(t)" "WAIT(w@/!)" "DELEGATED(g@/!)" "DEFER(r!/!)"
               "|" "DONE(d@)" "CANCELED(x@)")
...
"))
  ...
  (defsubst org-current-is-todo ()
    (member (org-get-todo-state) '("TODO" "EPIC" "STORY" "DOING")))
...
(use-package org-agenda
  ...
  (org-agenda-custom-commands
   '(("r" . "Review tasks")
     ...
     ("ru" "Unscheduled (last 90 days)" tags "TODO={TODO\\|WAIT\\|DELEGATED}&STYLE<>\"habit\""
     ...
     ("rU" "All unscheduled" tags "TODO={TODO\\|WAIT\\|DELEGATED}&STYLE<>\"habit\""
      ((org-agenda-skip-function
     ...
     ("ro" "Unscheduled open source" tags "TODO={TODO\\|WAIT\\|DELEGATED}&STYLE<>\"habit\""
      ((org-agenda-skip-function
     ...
     ("rW" "Unscheduled work" tags "TODO={TODO\\|WAIT\\|DELEGATED}&STYLE<>\"habit\""
     ...
     ("rw" "Waiting/delegated" tags "TODO={WAIT\\|DELEGATED}&STYLE<>\"habit\""
      ((org-agenda-skip-function
        '(org-agenda-skip-entry-if 'scheduled))
       (org-agenda-sorting-strategy
        '(todo-state-up priority-down category-up))))

     ("rd" "Deadlined" tags "TODO={TODO\\|WAIT\\|DELEGATED}&STYLE<>\"habit\""
      ((org-agenda-skip-function
        '(org-agenda-skip-entry-if 'notdeadline))
       (org-agenda-sorting-strategy '(category-up))))

     ("rs" "Scheduled" tags "TODO={APPT\\|TODO\\|WAIT\\|DELEGATED}&STYLE<>\"habit\""
      ((org-agenda-skip-function
        '(org-agenda-skip-entry-if 'notscheduled))
       (org-agenda-sorting-strategy '(category-up))))

     ("rD" "Deferred" tags "TODO=\"DEFER\""
      ((org-agenda-sorting-strategy '(user-defined-up))
       (org-agenda-prefix-format "%-11c%5(org-todo-age) ")))

     ("rI" "Impactful" tags "Impact&TODO={TODO\\|WAIT\\|DELEGATED}&STYLE<>\"habit\""
      ((org-agenda-sorting-strategy
     ...
     ("PA" "All priority #A tasks" tags "TODO={TODO\\|WAIT\\|DELEGATED}&STYLE<>\"habit\""
      ((org-agenda-skip-function
        '(org-agenda-skip-entry-if 'notregexp "\\[#A\\]"))
       (org-agenda-sorting-strategy '(user-defined-up))
       (org-agenda-prefix-format "%-11c%5(org-todo-age) ")))

     ("PB" "All priority #B tasks" tags "TODO={TODO\\|WAIT\\|DELEGATED}&STYLE<>\"habit\""
      ((org-agenda-skip-function
        '(org-agenda-skip-entry-if 'regexp "\\[#[AC]\\]"))
       (org-agenda-sorting-strategy '(user-defined-up))
       (org-agenda-prefix-format "%-11c%5(org-todo-age) ")))

     ("PC" "All priority #C tasks" tags "TODO={TODO\\|WAIT\\|DELEGATED}&STYLE<>\"habit\""
      ((org-agenda-skip-function
        '(org-agenda-skip-entry-if 'notregexp "\\[#C\\]"))
       (org-agenda-sorting-strategy '(user-defined-up))
       (org-agenda-prefix-format "%-11c%5(org-todo-age) ")))))
