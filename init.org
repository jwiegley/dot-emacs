...
(use-package wombag
  ...
  :custom
  (wombag-host "http://wallabag.vulcan.lan")
  (wombag-username "jwiegley@gmail.com")
  (wombag-password (lookup-password "wallabag.password" "jwiegley@gmail.com" 80))
  (wombag-client-id "3_3qigwe7ajfuokw8sk80c40sk08wkssk04gkogw88sswoo88o88")
  (wombag-client-secret (lookup-password "wallabag.secret" "jwiegley@gmail.com" 80)))
#+end_src
