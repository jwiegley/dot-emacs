...
(use-package message
  ...
  (message-mode-hook . (lambda () (set-fill-column 78)))
  (message-mode-hook . abbrev-mode)
  (message-mode-hook . footnote-mode)
  (message-mode-hook . jinx-mode)
  (message-mode-hook . turn-on-auto-fill)
...
(use-package org-review
  ...
  (:map
   ...
   ("4" . my-org-review-next-fuor-weeks)
...
(use-package citar
  ...
  (org-cite-global-bibliography
   (list (org-file "resource/bibliography.bib")
         (org-file "resource/kadena.bib")))
