...
(use-package gnus-start
  ...
  (gnus-parameters
   '(
     ;; Fastmail spam: Spam -> [Not Spam] -> INBOX
     ;; SpamSieve spam: IsSpam -> TrainGood -> INBOX
     ...
     t (list
        ...
        (cons
         ...
         '(("nnimap:imap.fastmail.com" "INBOX")
           ("nnimap:imap.fastmail.com" "Archive")
           ("nnimap:imap.fastmail.com" "mail/kadena")
           ("nnimap:imap.fastmail.com" "mail/kadena/archive")))))
    (gnus-summary-next-page))
