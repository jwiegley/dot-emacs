...
(eval-and-compile
  ...
  (defconst emacs-data-suffix
    (cond ((string= "emacsERC" emacs-environment) "alt")
          ((string-match "emacs[1-9][0-9]\\(.+\\)$" emacs-environment)
...
(use-package org-srs
  ...
  :bind (:map org-mode-map
              ...
              ("A-<right>" . org-srs-review-rate-easy)
              ("A-<up>"    . org-srs-review-rate-good)
              ("A-<down>"  . org-srs-review-rate-hard)
              ("A-<left>"  . org-srs-review-rate-again))
  :config
