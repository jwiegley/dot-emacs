...
(use-package org-smart-capture
  ...
  :bind* ("M-m" . (lambda ()
                    (interactive)
                    (org-smart-capture #'org-roam-create-new)))
  :custom
  (org-smart-capture-use-lastname t)
  :preface
  (cl-defun org-roam-create-new
...
,#+filetags: :roam:\n#+title: ${title}\n")
     ...
     ("N" "Inline Note" entry "* NOTE %?"
      :target (file+olp "~/org/area/todo.org" ("Inbox"))
      :prepend t)
     ("a" "Task" entry "* TODO %?"
      :target (file+olp "~/org/area/todo.org" ("Inbox"))
      :prepend t)
          ...
          (with-temp-buffer
            ...
            (cl-destructuring-bind (beg end _title2) (my-org-headline)
              ...
              (cl-destructuring-bind (beg end)
                  (my-org-property-drawer (point-max))
