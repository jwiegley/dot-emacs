...
;; Luminosity 15
(defconst palette-red-darker          "#5C0000")
(defconst palette-orange-darker       "#5C2E00")
(defconst palette-yellow-darker       "#5C5C00")
(defconst palette-yellow-green-darker "#2E5C00")
(defconst palette-green-darker        "#005C00")
(defconst palette-teal-darker         "#005C2E")
(defconst palette-cyan-darker         "#005C5C")
(defconst palette-slate-blue-darker   "#002E5C")
(defconst palette-blue-darker         "#00005C")
(defconst palette-indigo-darker       "#2E005C")
(defconst palette-purple-darker       "#5C005C")
(defconst palette-fuschia-darker      "#5C002E")
#+end_src
...
[PACKAGES]"
  ...
  (org-todo-keyword-faces
   `(
     ...
     ("FINISHED" :foreground ,palette-green-dark      :weight bold)
     ("CANCELED" :foreground "grey50"                 :weight bold :strike-through t)
     ("PROJECT"  :foreground ,palette-indigo          :weight bold)
     ("COMPLETE" :foreground ,palette-cyan-dark       :weight bold)
  ...
  (org-use-tag-inheritance '("Noon" "Day" "Eve" "Night" "Home" "Call" "Errand"))
...
(use-package org-agenda-overlay
  ...
  (org-agenda-overlay-by-filetag
   `(("c2g"           face (:background ,palette-orange-darker     :foreground "#eeeeee"))
     ...
     ("family"        face (:background ,palette-green-darker      :foreground "#eeeeee"))
  ...
  (org-agenda-overlay-by-olp
   `(;; Headings in todo.org
     ...
     ;; red
     (("Finances")    face (:background ,palette-red-darker        :foreground "#eeeeee"))
     ;; orange
     ;; yellow
     ...
     ;; blue
     (("Blog")        face (:background ,palette-blue-darker       :foreground "#eeeeee"))
     (("Personal")    face (:background ,palette-blue-darker       :foreground "#eeeeee"))
     ;; indigo
...
(use-package org-noter
  ...
  (use-package org-noter-dynamic-block)
...
(use-package org-remark
  ...
  :bind (("C-c n m" . org-remark-mark)
         ("C-c n M" . org-remark-mark-line) ; new in v1.3
...
(use-package org-review
  ...
  (defun my-org-reviewed-today ()
    (interactive)
    (when (ignore-errors (org-entry-is-todo-p))
      (save-excursion
...
(use-package org-roam-extra
  ...
  (advice-add 'org-agenda :before #'org-roam-extra-update-todo-files)
