...
(use-package gptel
  ...
  (add-hook 'gptel-mode-hook #'my/gptel-prepare-new-chat-buffer)
  ...
  (use-package gptel-backends
    ...
    (setq gptel-model 'Qwen3-235B-A22B
...
(use-package org-srs
  ...
  :bind (:map org-mode-map
              ...
              ("<right>" . org-srs-review-rate-easy)
              ("<up>"    . org-srs-review-rate-good)
              ("<down>"  . org-srs-review-rate-hard)
              ("<left>"  . org-srs-review-rate-again))
  :config
