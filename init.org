...
(use-package org
  ...
  (org-default-notes-file (org-file "area/todo.org"))
...
[PACKAGES]"
  ...
  (org-refile-targets
   `((org-agenda-files :maxlevel . 4)
     (,(org-file "area/bookmarks.org") :maxlevel . 2)))
...
(use-package org-agenda
   ...
   '(("r" . "Review tasks")
     ...
     ("ro" "Unscheduled open source" alltodo ""
      ((org-agenda-skip-function
       ...
       (org-agenda-prefix-format "%-11c%5(org-todo-age) ")
       (org-agenda-files (list (org-file "area/OSS.org")))))
      ...
      ((org-agenda-sorting-strategy '(category-up user-defined-up))
       (org-agenda-skip-function
        '(or (org-agenda-skip-entry-if 'scheduled 'deadline 'timestamp)
             ...
             (my-org-skip-inactive-todos)))
       (org-agenda-prefix-format "%-11c%5(org-todo-age) ")
       (org-agenda-files (list (org-file "area/kadena/kadena.org")))))
  ...
  (org-agenda-files
   (list (org-file "area/todo.org")
         (org-file "area/habits.org")
         (org-file "area/kadena/kadena.org")
         (org-file "area/OSS.org")
         (org-file "area/people.org")
...
(use-package org-contacts
  :after org
  :custom
  (org-contacts-files (list (org-file "area/people.org")))
  :config
...
(use-package org-noter
  ...
  :commands org-noter
  :custom
  (org-noter-notes-search-path (list (org-file "resource")))
       ...
       ((eq major-mode 'dired-mode)
        (let ((org-ql-search-directories-files-recursive t))
          (org-ql-find (org-ql-search-directories-files
                        :directories (list (org-file "area")
                                           (org-file "project")
                                           (org-file "resource")))
...
:NOTE: %^{NOTE}
:END:"
      :target (file ,(org-file "area/people.org"))
      :prepend t)
     ("C" "Calendar" entry "* APPT %?"
      :target (node "DB5226DB-93BD-4FDC-89C6-0DBE5D1A607E")
      :prepend t)
     ("n" "Note" plain "%?"
      :target (file+head "resource/%<%Y%m%d%H%M>-${slug}.org"
                         "#+title: ${title}\n")
      :jump-to-captured t
     ...
     ("N" "Inline Note" entry "* LINK %?"
      ...
      :prepend t)
     ("i" "Idea" entry "* NOTE %?"
      :target (file ,(org-file "area/ideas.org"))
      :empty-lines 1
      :prepend t)
     ("q" "Quote" plain "%c\n\n─ %?"
      :target (file+head "resource/%<%Y%m%d%H%M>-${slug}.org"
...
(use-package citar
  ...
  (org-cite-global-bibliography
   (list (org-file "area/bibliography.bib")
         (org-file "area/kadena.bib")))
...
(use-package asana
  ...
  :defines (asana-token)
  :custom
  (asana-tasks-org-file (org-file "area/kadena/asana.org"))
  :config
  (setq asana-token
