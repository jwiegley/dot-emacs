...
[PACKAGES]"
  ...
  (defconst my-org-open-todo-keywords
    '("STARTED"
      "TODO"
      "WAITING"
      "DELEGATED"
      ...
      "STORY"
      "APPT")
    "Keywords that represent a TODO in an open state.")
...
(use-package org-agenda
  ...
  (org-agenda-custom-commands
   '(("r" . "Review tasks")
     ...
     ("ru" "Unscheduled (last 90 days)" tags "TODO={TODO\\|WAITING\\|DELEGATED}&STYLE<>\"habit\""
     ...
     ("rU" "All unscheduled" tags "TODO={TODO\\|WAITING\\|DELEGATED}&STYLE<>\"habit\""
      ((org-agenda-skip-function
     ...
     ("ro" "Unscheduled open source" tags "TODO={TODO\\|WAITING\\|DELEGATED}&STYLE<>\"habit\""
      ((org-agenda-skip-function
        '(org-agenda-skip-entry-if 'scheduled 'deadline 'timestamp 'regexp
                                   "\\* \\(DEFERRED\\|SOMEDAY\\)"))
       (org-agenda-sorting-strategy '(category-up))
       (org-agenda-prefix-format "%-11c%5(org-todo-age) ")
       (org-agenda-files '("~/org/area/OSS.org"))))

     ("rW" "Unscheduled work" tags "TODO={TODO\\|WAITING\\|DELEGATED}&STYLE<>\"habit\""
     ...
     ("rw" "Waiting/delegated" tags "TODO={WAITING\\|DELEGATED}&STYLE<>\"habit\""
      ((org-agenda-skip-function
        '(org-agenda-skip-entry-if 'scheduled))
       (org-agenda-sorting-strategy
        '(todo-state-up priority-down category-up))))

     ("rd" "Deadlined" tags "TODO={TODO\\|WAITING\\|DELEGATED}&STYLE<>\"habit\""
      ((org-agenda-skip-function
        '(org-agenda-skip-entry-if 'notdeadline))
       (org-agenda-sorting-strategy '(category-up))))

     ("rs" "Scheduled" tags "TODO={APPT\\|TODO\\|WAITING\\|DELEGATED}&STYLE<>\"habit\""
      ((org-agenda-skip-function
        '(org-agenda-skip-entry-if 'notscheduled))
       (org-agenda-sorting-strategy '(category-up))))

     ("rD" "Deferred" tags "TODO=\"DEFERRED\""
      ((org-agenda-sorting-strategy '(user-defined-up))
       (org-agenda-prefix-format "%-11c%5(org-todo-age) ")))

     ("rY" "Someday" tags "TODO=\"SOMEDAY\""
      ((org-agenda-sorting-strategy '(user-defined-up))
       (org-agenda-prefix-format "%-11c%5(org-todo-age) ")))

     ("rI" "Impactful" tags "Impact&TODO={TODO\\|WAITING\\|DELEGATED}&STYLE<>\"habit\""
      ((org-agenda-sorting-strategy
        '(todo-state-up priority-down user-defined-up))
       (org-agenda-prefix-format "%-11c%5(org-todo-age) ")))

     ("rp" "With tags"
      (lambda (arg) (call-interactively #'org-extra-with-tags-search nil)))

     ("rc" "With category"
      (lambda (arg) (call-interactively #'org-extra-with-category-search nil)))

     ("rt" "With item"
      (lambda (arg) (call-interactively #'org-extra-with-item-search nil)))
     ...
     ("pp" "All Projects" tags "TODO=\"PROJECT\"")

     ("pn" "Project Next Actions" alltodo ""
      ((org-agenda-skip-function #'my-org-agenda-skip-all-siblings-but-first)))

     ("po" "Non-Hot Projects" tags "-HOT&TODO=\"PROJECT\"")

     ("ph" "Hot Projects" tags "HOT&TODO=\"PROJECT\"")

     ("pH" "Current Hotlist" alltodo ""
     ...
     ("PA" "All priority #A tasks" tags "TODO={TODO\\|WAITING\\|DELEGATED}&STYLE<>\"habit\""
      ((org-agenda-skip-function
        '(org-agenda-skip-entry-if 'notregexp "\\[#A\\]"))
       (org-agenda-sorting-strategy '(user-defined-up))
       (org-agenda-prefix-format "%-11c%5(org-todo-age) ")))

     ("PB" "All priority #B tasks" tags "TODO={TODO\\|WAITING\\|DELEGATED}&STYLE<>\"habit\""
      ((org-agenda-skip-function
        '(org-agenda-skip-entry-if 'regexp "\\[#[AC]\\]"))
       (org-agenda-sorting-strategy '(user-defined-up))
       (org-agenda-prefix-format "%-11c%5(org-todo-age) ")))

     ("PC" "All priority #C tasks" tags "TODO={TODO\\|WAITING\\|DELEGATED}&STYLE<>\"habit\""
      ((org-agenda-skip-function
        '(org-agenda-skip-entry-if 'notregexp "\\[#C\\]"))
       (org-agenda-sorting-strategy '(user-defined-up))
       (org-agenda-prefix-format "%-11c%5(org-todo-age) ")))))
...
(use-package org-noter
  ...
  :commands org-noter
  :custom
  (org-noter-notes-search-path '("~/org/inbox"))
...
(use-package org-ql
  ...
  :functions (org-ql-find--buffers
              ...
              org-ql-find)
  :bind
  ("M-g o" . my/org-ql-find-with-heading)
  :preface
  ...
  (defun my/org-ql-find-with-heading (&optional arg)
    (interactive "P")
    (require 'org-ql)
    (require 'org-ql-find)
       ...
       ((eq major-mode 'dired-mode)
        (let ((org-ql-search-directories-files-recursive t))
          (org-ql-find (org-ql-search-directories-files
                        :directories '("~/org/area" "~/org/resource"))
                       :query-prefix "todo:CATEGORY,PROJECT ")))
       ((eq major-mode 'org-mode)
        (org-ql-find (org-ql-find--buffers)
                     :query-prefix (if arg nil "todo:CATEGORY,PROJECT ")))
       (t
        (org-ql-find (org-agenda-files)
                     :query-prefix (if arg nil "todo:CATEGORY,PROJECT "))))))
  :config
  (add-to-list 'vertico-multiform-commands '(org-ql-find))
  (add-to-list 'vertico-multiform-commands '(my/org-ql-find-with-heading))
...
(use-package org-sync
  ...
  :bind (:map
         ...
         ("C-c C-x S" . org-sync))
  :custom
  (org-sync-files '("~/org/area/todo.org"
                    "~/org/area/OSS.org"
                    "~/org/area/kadena/kadena.org"
                    "~/org/area/bahai/assembly/assembly.org"))
  :preface
  (defcustom org-sync-files nil
    "Regular expressions to identify foolish content.
    Usually what happens is that you add the bots to
    `erc-ignore-list' and the bot commands to this list."
    :group 'org
...
(use-package asana
  ...
  :defines (asana-token)
  :custom
  (asana-tasks-org-file "~/org/area/kadena/asana.org")
  :config
  (setq asana-token
