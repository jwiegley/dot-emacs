(custom-set-variables
 ...
 '(bm-in-lifo-order t)
 '(bm-repository-file "/Users/johnw/.emacs.d/data/bm-repository" t)
 ...
 '(company-global-modes '(emacs-lisp-mode haskell-mode c-mode c++-mode))
 ...
 '(erc-services-mode t)
 '(erc-text-matched-hook '(erc-hide-fools my-erc-hook))
 ...
 '(flyspell-incorrect-hook '(my-flyspell-maybe-correct-transposition))
 ...
 '(nsm-settings-file "/Users/johnw/.emacs.d/data/network-security.data" t)
 ...
 '(persistent-scratch-save-file "/Users/johnw/.emacs.d/data/persistent-scratch" t)
 ...
 '(url-configuration-directory "~/.emacs.d/data/url/" t)
