(custom-set-variables
 ...
 '(erc-autojoin-channels-alist (quote (("freenode.net" "##categorytheory" "#agda" "#coq" "#ghc" "#haskell" "#haskell-infrastructure" "#haskell-llvm" "#idris" "#ledger") ("well-typed" "#fpcomplete"))))
