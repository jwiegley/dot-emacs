...
")
 ...
 '(gnus-parameters (quote (("list\\." (subscribed . t)) ("list\\.wg21\\.\\(.*\\)" (to-address . "c++std-@accu.org") (to-list . "c++std-@accu.org") (gcc-self . t) (gnus-list-identifiers "\\[c\\+\\+std-.+?\\]")) ("INBOX" (total-expire . t) (expiry-wait . 14) (expiry-target . "mail.archive")) ("mail\\." (gnus-use-scoring nil)) ("mail\\.archive" (gnus-summary-line-format "%«%U%R %uS %ur %»%(%*%-14,14f   %4u&size; %1«%B%s%»%)
")) ("list\\.ledger\\.devel" (to-address . "ledger-cli@googlegroups.com") (to-list . "ledger-cli@googlegroups.com")) ("list\\.bahai\\.tarjuman" (to-address . "TARJUMAN-LIST@listserv.buffalo.edu") (to-list . "TARJUMAN-LIST@listserv.buffalo.edu")) ("list\\.emacs\\.devel" (to-address . "emacs-devel@gnu.org") (to-list . "emacs-devel@gnu.org")) ("list\\.emacs\\.orgmode" (to-address . "emacs-orgmode@gnu.org") (to-list . "emacs-orgmode@gnu.org") (list-identifier . "\\[O\\]")) ("list\\.boost\\.cppnow" (to-address . "boostcon-plan@googlegroups.com") (to-list . "boostcon-plan@googlegroups.com")) ("list\\.boost\\.ryppl" (to-address . "ryppl-dev@googlegroups.com") (to-list . "ryppl-dev@googlegroups.com")) ("list\\.boost\\.devel" (to-address . "boost@lists.boost.org") (to-list . "boost@lists.boost.org") (list-identifier . "\\[boost\\]")) ("list\\.boost\\.users" (to-address . "boost-users@lists.boost.org") (to-list . "boost-users@lists.boost.org") (list-identifier . "\\[Boost-users\\]")) ("list\\.isocpp\\.proposals" (to-address . "std-proposals@isocpp.org") (to-list . "std-proposals@isocpp.org") (list-identifier . "\\[\\(lang\\|lib\\|std\\)-proposals\\]")) ("list\\.isocpp\\.discussion" (to-address . "std-discussion@isocpp.org") (to-list . "std-discussion@isocpp.org") (list-identifier . "\\[\\(lang\\|lib\\|std\\)-discussion\\]")) ("list\\.clang\\.devel" (to-address . "cfe-dev@cs.uiuc.edu") (to-list . "cfe-dev@cs.uiuc.edu") (list-identifier . "\\[cfe-dev\\]")) ("list\\.llvm\\.devel" (to-address . "llvmdev@cs.uiuc.edu") (to-list . "llvmdev@cs.uiuc.edu")))))
...
(custom-set-faces
 ...
 '(helm-selection ((t (:background "chartreuse" :underline t))))
 '(helm-source-header ((t (:background "deep sky blue" :foreground "white" :underline t))))
