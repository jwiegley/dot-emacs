(custom-set-variables
 ...
 '(erc-autojoin-channels-alist (quote (("freenode.net" "##categorytheory" "#agda" "#coq" "#idris" "#gitlib" "#haskell" "#haskell-lens" "#ledger" "#ChicagoHaskell" "#haskell-ops" "#nixos" "#wigfam"))))
 ...
 '(erc-modules (quote (autojoin button completion dcc fill identd irccontrols list match menu move-to-prompt netsplit networks noncommands readonly replace ring scrolltobottom services smiley stamp track truncate highlight-nicknames)))
 '(erc-nick "johnw")
 '(erc-port 6667)
 ...
 '(safe-local-variable-values (quote ((nix-package-name . "pkgs.haskellPackages_ghc782.newartisans") (eval require (quote edg)) (eval ignore-errors (require (quote edg))) (after-save-hook git-commit-changes) (shm-lambda-indent-style . leftmost-parent) (haskell-indent-spaces . 4) (haskell-indent-spaces . 2) (coq-prog-args "-emacs-U" "-no-native-compiler" "-R" "." "Hask") (coq-prog-args "-emacs" "-R" "." "Hask"))))
