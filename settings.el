(custom-set-variables
 ...
 '(initsplit-customizations-alist (quote (("\\`\\(gnus\\|nn\\|message\\|mail\\|mm-\\|smtp\\|send-mail\\|check-mail\\|sc-\\)" "~/.emacs.d/gnus-settings.el" t nil) ("\\`\\(org-\\)" "~/.emacs.d/org-settings.el" t nil))))
...
(custom-set-faces
 ...
 '(diff-file-header ((t (:foreground "White" :background "Gray50"))) t)
 '(diff-header ((t (:foreground "Blue"))) t)
 '(diff-hunk-header ((t (:foreground "Salmon" :background "Gray90"))) t)
