(custom-set-variables
 ...
 '(gnus-group-line-format "%S%p%P%5N: %(%B%G%B%)
")
 ...
 '(gnus-refer-article-method (quote (current (nnir "LocalNews") (nnweb "gmane" (nnweb-type gmane)) (nnweb "refer" (nnweb-type google)))))
