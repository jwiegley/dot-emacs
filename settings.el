(custom-set-variables
 ...
 '(agda2-include-dirs (quote ("." "/Users/johnw/.nix-profile/share/agda-prelude" "/Users/johnw/.nix-profile/share/agda")))
 ...
 '(cc-other-file-alist (quote (("\\.hs\\'" (".hs-boot")) ("\\.cc\\'" (".hh" ".h")) ("\\.hh\\'" (".cc" ".C")) ("\\.c\\'" (".h")) ("\\.h\\'" (".c" ".cc" ".C" ".CC" ".cxx" ".cpp")) ("\\.C\\'" (".H" ".hh" ".h")) ("\\.H\\'" (".C" ".CC")) ("\\.CC\\'" (".HH" ".H" ".hh" ".h")) ("\\.HH\\'" (".CC")) ("\\.c\\+\\+\\'" (".h++" ".hh" ".h")) ("\\.h\\+\\+\\'" (".c++")) ("\\.cpp\\'" (".hpp" ".hh" ".h")) ("\\.hpp\\'" (".cpp")) ("\\.cxx\\'" (".hxx" ".hh" ".h")) ("\\.hxx\\'" (".cxx")))))
 ...
 '(compilation-search-path (quote (nil "/Users/johnw/src/gitlib" "/Users/johnw/src/gitlib/gitlib" "/Users/johnw/src/gitlib/gitlib-libgit2" "/Users/johnw/src/gitlib/gitlib-s3" "/Users/johnw/src/gitlib/gitlib-test" "/Users/johnw/src/gitlib/git-monitor" "/Users/johnw/src/c2hsc")))
 ...
 '(erc-autojoin-channels-alist (quote (("freenode.net" "##categorytheory" "#agda" "#ghc" "#gitlib" "#hackage" "#haskell" "#haskell-emacs" "#haskell-in-depth" "#haskell-infrastructure" "#haskell-lens" "#haskell-llvm" "#haskell-overflow" "#ledger" "#ChicagoHaskell" "#haskell-ops" "#nixos"))))
 ...
 '(erc-modules (quote (autojoin button completion dcc fill identd irccontrols list match menu move-to-prompt netsplit networks noncommands readonly replace ring scrolltobottom services smiley stamp spelling track truncate highlight-nicknames)))
 '(erc-nick "johnw")
 '(erc-port 6667)
 ...
 '(safe-local-variable-values (quote ((nix-package-name . "pkgs.haskellPackages_ghc782.newartisans") (eval require (quote edg)) (eval ignore-errors (require (quote edg))) (after-save-hook git-commit-changes) (shm-lambda-indent-style . leftmost-parent) (haskell-indent-spaces . 4) (haskell-indent-spaces . 2))))
 ...
 '(tramp-remote-path (quote ("/run/current-system/sw/bin" tramp-default-remote-path "/bin" "/usr/bin" "/sbin" "/usr/sbin" "/usr/local/bin" "/usr/local/sbin" "/opt/bin" "/opt/sbin" "/opt/local/bin")))
