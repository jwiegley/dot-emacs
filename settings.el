(custom-set-variables
 ...
 '(agda2-include-dirs (quote ("." "/usr/local/tools/agda/lib-0.7/src")))
 ...
 '(erc-autojoin-channels-alist (quote (("freenode.net" "##categorytheory" "#agda" "#ghc" "#gitlib" "#hackage" "#haskell" "#haskell-emacs" "#haskell-in-depth" "#haskell-infrastructure" "#haskell-lens" "#haskell-llvm" "#haskell-overflow" "#idris" "#ledger") ("well-typed" "#fpcomplete") ("ircbrowse.net" "#fpco"))))
