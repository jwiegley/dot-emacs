...
(custom-set-variables
 ...
 '(gnus-after-getting-new-news-hook (quote (gnus-group-list-groups gnus-group-save-newsrc (lambda nil (if (file-exists-p "/tmp/unread") (delete-file "/tmp/unread")) (ignore (quote display-time-update))) gnus-display-time-event-handler)))
...
")
 ...
 '(message-sent-hook (quote (my-gnus-score-followup-thread)))
