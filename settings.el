(custom-set-variables
 ...
 '(erc-modules (quote (button completion dcc fill identd irccontrols list log match menu move-to-prompt netsplit networks noncommands readonly replace ring scrolltobottom services smiley stamp spelling track truncate highlight-nicknames)))
 '(erc-nick "johnw")
 '(erc-port 6667)
 ...
 '(history-length 200)
 '(hoogle-binary-path "/Users/johnw/.cabal/bin/hoogle")
