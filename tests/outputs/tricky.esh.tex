...
\begin{ESHBlock}
\ESHBol{}\ESHSlantItalic{a}\ESHBox{.}{1.00pt}{\ESHSlantItalic{bcd\textcolor[HTML]{FF0000}{ef}}\textcolor[HTML]{FF0000}{gh}\ESHWeightBold{\textcolor[HTML]{FF0000}{ij}kl}}\ESHWeightBold{mn}\ESHEol
\ESHBol{}123\textscale{2.5}{4}56789
\end{ESHBlock}

\section*{\texttt{line-height}}
\begin{ESHBlock}
\ESHBol{}tall\ESHStrut{2}\ESHEol
\ESHBol{}tall\ESHStrut{2}\ESHEol
\ESHBol{}short\ESHEol
\ESHBol{}short
\end{ESHBlock}
...
\section*{\texttt{raise}}
\begin{ESHBlock}
\ESHBol{}x\ESHRaise{1.00}{abc123}\ESHEol
\ESHBol{}y\ESHRaise{-1.00}{abc123}
\end{ESHBlock}

\section*{Multi-line properties}
\begin{ESHBlock}
\ESHBol{}\ESHSlantItalic{\textcolor[HTML]{5F615C}{;;\ESHSpace{}this\ESHSpace{}comment}}\ESHEol
\ESHBol{}\ESHSlantItalic{\textcolor[HTML]{5F615C}{;;\ESHSpace{}spans}}\ESHEol
\ESHBol{}\ESHSlantItalic{\textcolor[HTML]{5F615C}{;;\ESHSpace{}multiple}}\ESHEol
\ESHBol{}\ESHSlantItalic{\textcolor[HTML]{5F615C}{;;\ESHSpace{}lines}}
\end{ESHBlock}

\section*{Overlays}
\begin{ESHBlock}
\ESHBol{}\textcolor[HTML]{FF0000}{ab\ESHColorBox{00FF00}{cd\ESHSlantItalic{\ESHWeightBold{ef}}}}\ESHBox{000000}{1.00pt}{\ESHSlantItalic{\ESHWeightBold{\ESHColorBox{00FF00}{\textcolor[HTML]{FF0000}{gh}ij}klm}}no}\uline{before}\ESHColorBox{0000FF}{display}\uline{after}
\end{ESHBlock}
