   ...
   (quote
    (("Ledger Mailing List"
     ...
     ("Emacs Newsgroups"
      ...
      "NewArtisans")
     ("Haskell Groups"
      ("Newsgroups" "\\(haskell\\|ghc\\|nix\\|coq\\|ssreflect\\)" current)
      "NewArtisans")
     ("Haskell Mailing Lists"
      ("To" "\\(haskell\\|ghc\\|nix\\|coq\\|ssreflect\\)" current)
      "NewArtisans"))))
...
")
 ...
 '(message-sendmail-extra-arguments (quote ("-C" "/Users/johnw/Messages/msmtp.conf")))
