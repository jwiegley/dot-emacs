...
;; Author: Thomas Link <t DOT link AT gmx DOT at>
...
(defconst filesets-version "1.8.6"
...
(defcustom filesets-use-file-name-history-flag nil
...
;  (sleep-for filesets-find-file-delay)
  (when (or (file-readable-p file)
    ...
    (find-file file)
    (when filesets-use-file-name-history-flag
