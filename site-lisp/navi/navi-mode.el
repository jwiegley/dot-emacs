...
(defcustom navi-keywords
  '(("emacs-lisp" . ((:ALL . "^[[:space:]]*(\\(use-package[[:space:]]+\\|\\(cl-\\)\\{0,1\\}def[a-z]+\\)\\*? ")
                     ...
                     (:FUN
                      . "^[[:space:]]*(\\(cl-\\)\\{0,1\\}*def[maus][^eltu][a-z]*\\*? ")
                     (:defun . "^[[:space:]]*(\\(cl-\\)\\{0,1\\}*defun\\*? ")
                     (:defvar . "^[[:space:]]*(\\(cl-\\)\\{0,1\\}defvar ")
                     (:defconst . "^[[:space:]]*(\\(cl-\\)\\{0,1\\}defconst ")
                     (:defgroup . "^[[:space:]]*(\\(cl-\\)\\{0,1\\}defgroup ")
                     (:defcustom . "^[[:space:]]*(\\(cl-\\)\\{0,1\\}defcustom ")
                     (:defadvice . "^[[:space:]]*(\\(cl-\\)\\{0,1\\}defadvice ")
                     (:defalias . "^[[:space:]]*(\\(cl-\\)\\{0,1\\}defalias ")
                     (:defmarcro . "^[[:space:]]*(\\(cl-\\)\\{0,1\\}defmacro\\*? ")
                     (:defface . "^[[:space:]]*(\\(cl-\\)\\{0,1\\}defface ")
                     (:defstruct . "^[[:space:]]*(\\(cl-\\)\\{0,1\\}defstruct ")
                     (:defsubst . "^[[:space:]]*(\\(cl-\\)\\{0,1\\}defsubst ")
                     (:defclass . "^[[:space:]]*(\\(cl-\\)\\{0,1\\}defclass ")
                     (:defmethod . "^[[:space:]]*(\\(cl-\\)\\{0,1\\}defmethod ")
                     (:declare . "^[[:space:]]*(\\(cl-\\)\\{0,1\\}declare-")
                     (:define . "^[[:space:]]*(\\(cl-\\)\\{0,1\\}define-")
                     (:global-set-key
		      . "^[[:space:]]*(\\(cl-\\)\\{0,1\\}global-set-key ")
                     (:add-to-list . "^[[:space:]]*(\\(cl-\\)\\{0,1\\}add-to-list ")
                     (:setq . "^[[:space:]]*(\\(cl-\\)\\{0,1\\}setq ")
                     (:add-hook . "^[[:space:]]*(\\(cl-\\)\\{0,1\\}add-hook ")
                     (:hook . "-hook-?")
                     (:lambda . "(lambda (")
                     (:ert . "^[[:space:]]*(ert-")
