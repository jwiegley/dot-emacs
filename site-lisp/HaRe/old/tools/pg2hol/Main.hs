-- $Id: Main.hs,v 1.5 2001/10/10 23:43:23 hallgren Exp $

-- Currently a test harness for lexer/parser/pretty printer/prop2hol.
...
testProp2HOL f s = prop2HOL $ testParser f s
