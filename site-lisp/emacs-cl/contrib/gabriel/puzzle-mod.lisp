;; $Header: /usr/local/cvsroot/emacs-cl/contrib/gabriel/puzzle-mod.cl,v 1.1 2004/05/05 05:41:56 lars Exp $
;; $Locker:  $
...
(eval-when (:compile-toplevel)
  (cl:spy (macroexpand '(fref piececount (fref puzzle-class i)))))
