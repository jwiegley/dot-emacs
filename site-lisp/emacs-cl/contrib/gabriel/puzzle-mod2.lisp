;; $Header: /usr/local/cvsroot/emacs-cl/contrib/gabriel/puzzle-mod2.cl,v 1.1 2004/05/05 05:41:56 lars Exp $
;; $Locker:  $
...
(proclaim '(function puzzle-remove (fixnum fixnum) fixnum))
(defun jil () 3)
(defun place (i j)
  (declare (type fixnum i j))
  (let ((end (aref piecemax i)))
